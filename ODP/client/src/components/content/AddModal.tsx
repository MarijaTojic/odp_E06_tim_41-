...
export default function AddModal({ modalContent, onClose, onSave }: AddModalProps) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/40 backdrop-blur-sm">
      <div className="bg-white rounded-3xl shadow-2xl p-6 w-11/12 max-w-lg relative">
        <button
          onClick={onClose}
        ...
        <div className="flex justify-end space-x-2">
          ...
          <button
            onClick={handleSave}
            className="px-4 py-2 rounded-xl bg-green-500 hover:bg-green-600 text-white font-bold transition"
          >
            Sačuvaj
          </button>
        </div>
